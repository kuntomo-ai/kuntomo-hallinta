    ...
    <div>
      <div className="page-header">
        <div className="page-header-left">
          ...
          <p className="page-subtitle">Kirjanpito- ja muut asiakirjat</p>
        </div>
        ...
        <table>
          ...
          <tbody>
            {loading ? (
              ...
              <tr><td colSpan={6} className="table-empty">Ei dokumentteja.</td></tr>
            ) : rows.map(r => (
              <tr key={r.id}>
                <td style={{ fontWeight: 600 }}>{r.title}</td>
                <td><span className="badge badge-gray">{r.document_type}</span></td>
                <td style={{ color: 'var(--text3)', fontSize: '.82rem' }}>{r.period || '—'}</td>
